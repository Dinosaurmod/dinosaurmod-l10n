...
This repository also contains scripts that we use to maintain TurboWarp's translations. They assume you have a directory laid out with `dinosaurmod.github.io` in the same parent folder.
